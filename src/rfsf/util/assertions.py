...
from rfsf.util.tensor_util import NdTensor
...
def assert_dim(x: NdTensor, expected_dim: int, name: str) -> NoReturn:
...
def assert_scalar(x: NdTensor, name: str) -> NoReturn:
...
def assert_axis_length(x: NdTensor, axis: int, expected_length: int, name: str) -> NoReturn:
...
def assert_same_axis_length(x1: NdTensor, x2: NdTensor, axis1: int, name1: str, name2: str, axis2: Optional[int] = None) -> NoReturn:
...
def assert_shape(x: NdTensor, expected_shape: Tuple[int], name: str) -> NoReturn:
