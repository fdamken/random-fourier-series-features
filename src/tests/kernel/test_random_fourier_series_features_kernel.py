...
def test_constructor():
    RandomFourierSeriesFeaturesKernel(2, 100, RandomFourierSeriesInitializer(10, 0))
...
def test_compute(samples_p, samples_q, dim):
    rff = RandomFourierSeriesFeaturesKernel(dim, 100, RandomFourierSeriesInitializer(10, 0))
...
def test_parameters():
    rff = RandomFourierSeriesFeaturesKernel(1, 1, RandomFourierSeriesInitializer(10, 0))
