\newcommand{\tikzHypercube}{
    \begin{tikzpicture}[
        ...
        \node [corner] (stationary-kernel-learning)     at (\spread,        0,        0) {\small Manifold GPs};
        ...
        \node [corner] (nonstationary-kernel-learning)  at (\spread,        0, -\spread) {\small NTK};
